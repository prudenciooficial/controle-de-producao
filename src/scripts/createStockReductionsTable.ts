export const showStockReductionsTableInstructions = () => {
  console.log(`
    ========================================
    INSTRUÇÕES PARA CRIAR TABELA BAIXAS_ESTOQUE
    ========================================
    
    A tabela 'baixas_estoque' precisa ser criada manualmente no painel do Supabase.
    ...
    ========================================
    Após executar o SQL, a funcionalidade de baixas de estoque estará disponível.
    ========================================
  `);
};

// Executar automaticamente
showStockReductionsTableInstructions(); 